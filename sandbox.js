 /* ===========================
  ...
  function selectPhoto(eventId, thumbIdx, imgSrc) {
    ...
    /* ===========================
     OFFICERS HOVER IMAGE SWAP
  =========================== */

  function officerImageSwap() {
    const officerCards = document.querySelectorAll('.card.officer-card'); //.card.officer-card == elements with both classes

    officerCards.forEach(officerCard => {
      const officerImg = officerCard.querySelector('.pic-size');

      const origSrc = officerImg.src;
      const hoverSrc = officerImg.dataset.hover;

      officerImg.addEventListener('mouseenter', () => {
        officerImg.src = hoverSrc;
      });

      officerImg.addEventListener('mouseleave', () => {
        officerImg.src = origSrc;
      })
